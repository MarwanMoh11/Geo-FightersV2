...
export const LEVEL_1_NEON_SLUMS: LevelConfig = {
    ...
    obstacles: [
        // === BORDER WALLS ===
        // North Wall
        { id: 'wall_n', x: 0, z: -MAP_HALF_HEIGHT - WALL_THICKNESS / 2, width: 800 + WALL_THICKNESS * 2, depth: WALL_THICKNESS, type: 'wall', blocking: true },
        // South Wall
        { id: 'wall_s', x: 0, z: MAP_HALF_HEIGHT + WALL_THICKNESS / 2, width: 800 + WALL_THICKNESS * 2, depth: WALL_THICKNESS, type: 'wall', blocking: true },
        // East Wall
        { id: 'wall_e', x: MAP_HALF_WIDTH + WALL_THICKNESS / 2, z: 0, width: WALL_THICKNESS, depth: 800, type: 'wall', blocking: true },
        // West Wall
        { id: 'wall_w', x: -MAP_HALF_WIDTH - WALL_THICKNESS / 2, z: 0, width: WALL_THICKNESS, depth: 800, type: 'wall', blocking: true },

        // === INDUSTRIAL GATE (Northwest) ===
        // Zone: x=-400 to -250, z=-400 to -200
        // Large gate structures creating chokepoint
        { id: 'gate_left', x: -375, z: -320, width: 40, depth: 60, type: 'wall', blocking: true, asset: '/textures/environments/prop_container.png' },
        { id: 'gate_right', x: -290, z: -320, width: 40, depth: 60, type: 'wall', blocking: true, asset: '/textures/environments/prop_container.png' },
        ...
        // Abandoned taxis
        { id: 'taxi_1', x: -100, z: -350, width: 25, depth: 45, type: 'prop', blocking: true, asset: '/textures/environments/prop_taxi.png' },
        { id: 'taxi_2', x: 80, z: -320, width: 25, depth: 45, type: 'prop', blocking: true, asset: '/textures/environments/prop_taxi.png' },
        { id: 'taxi_3', x: 250, z: -360, width: 25, depth: 45, type: 'prop', blocking: true, asset: '/textures/environments/prop_taxi.png' },
        ...
        { id: 'scrap_1', x: -330, z: 0, width: 25, depth: 25, type: 'prop', blocking: true, asset: '/textures/environments/prop_scrap.png' },
        { id: 'scrap_2', x: -260, z: 120, width: 30, depth: 20, type: 'prop', blocking: true, asset: '/textures/environments/prop_scrap.png' },
        { id: 'scrap_3', x: -350, z: 200, width: 20, depth: 30, type: 'prop', blocking: true, asset: '/textures/environments/prop_scrap.png' },
        // Broken mech
        { id: 'mech', x: -370, z: 100, width: 35, depth: 35, type: 'prop', blocking: true, asset: '/textures/environments/prop_mech.png' },
        // Cargo containers
        { id: 'container_1', x: -280, z: -20, width: 50, depth: 25, type: 'prop', blocking: true, asset: '/textures/environments/prop_container.png' },
        { id: 'container_2', x: -210, z: 150, width: 50, depth: 25, type: 'prop', blocking: true, asset: '/textures/environments/prop_container.png' },
        ...
        { id: 'vending_1', x: -50, z: 50, width: 15, depth: 25, type: 'prop', blocking: true, asset: '/textures/environments/prop_vending.png' },
        { id: 'vending_2', x: 250, z: 80, width: 15, depth: 25, type: 'prop', blocking: true, asset: '/textures/environments/prop_vending.png' },
        { id: 'vending_3', x: 180, z: 300, width: 15, depth: 25, type: 'prop', blocking: true, asset: '/textures/environments/prop_vending.png' },
        { id: 'vending_4', x: -80, z: 280, width: 15, depth: 25, type: 'prop', blocking: true, asset: '/textures/environments/prop_vending.png' },
        // Benches
        { id: 'bench_1', x: 30, z: 150, width: 30, depth: 10, type: 'prop', blocking: true, asset: '/textures/environments/prop_bench.png' },
        { id: 'bench_2', x: 170, z: 180, width: 30, depth: 10, type: 'prop', blocking: true, asset: '/textures/environments/prop_bench.png' },
        { id: 'bench_3', x: 50, z: 250, width: 30, depth: 10, type: 'prop', blocking: true, asset: '/textures/environments/prop_bench.png' },
        { id: 'bench_4', x: 280, z: 200, width: 30, depth: 10, type: 'prop', blocking: true, asset: '/textures/environments/prop_bench.png' },
...
export function isPointInObstacle(x: number, z: number, obstacle: Obstacle): boolean {
    ...
    return x >= obstacle.x - halfW && x <= obstacle.x + halfW &&
        z >= obstacle.z - halfD && z <= obstacle.z + halfD;
}

// Helper: Check AABB collision between entity and obstacle
export function checkAABBCollision(
    entityX: number, entityZ: number, entityRadius: number,
    obstacle: Obstacle
